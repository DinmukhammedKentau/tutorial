...
def main():
    ...
    while run:
        for event in pygame.event.get():
            ...
            if coor[0] > 0.9 * w + 10 and coor[1] > h - 0.7 * h and coor[0] <= 0.9 * w + 50 and coor[
                1] <= h - 0.7 * h + 25:
            ...
            if coor[0] > 0.9 * w + 10 and coor[1] > h - 0.7 * h + 30 and coor[0] <= 0.9 * w + 50 and coor[
                1] <= h - 0.7 * h + 55:
                if pygame.mouse.get_pressed()[0]:
                    color = red
                    rect = False
            ...
            if coor[0] > 0.9 * w + 10 and coor[1] > h - 0.7 * h + 60 and coor[0] <= 0.9 * w + 50 and coor[
                1] <= h - 0.7 * h + 85:
                if pygame.mouse.get_pressed()[0]:
                    color = green
                    pen = True
            ...
            if coor[0] > 0.9 * w + 10 and coor[1] > h - 0.7 * h + 90 and coor[0] <= 0.9 * w + 50 and coor[
                1] <= h - 0.7 * h + 115:
                if pygame.mouse.get_pressed()[0]:
                    color = backround
                    pen = True
            ...
            if event.type == pygame.MOUSEBUTTONDOWN and tri and coor[1] > h * 0.1 and coor[0] < w * 0.9 - 10:
                if start_pos is None:
                    ...
                    pygame.draw.polygon(screen, color, [(start_pos[0], start_pos[1]), (mid_pos[0], mid_pos[1]),
                                                        (end_pos[0], end_pos[1])])
